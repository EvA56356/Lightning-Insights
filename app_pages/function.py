...
from configs import OPENAI_GPT3, OPENAI_GPT4, CLAUDE_DEFAULT, REVIEW_NUM_CAP, OPENAI_CAP, ANALYSIS_FOCUS, USER_POSITION, CONTENT_COL_CONFIG
    ...
    with center:
        ...
        with step3_block:
            ...
            with advanced_options: 
                ...
                with step3c_col1: 
                    selected_model = st.selectbox(texts['step_three_selected_model'][language], [texts['step_three_selected_model2'][language], OPENAI_GPT3, OPENAI_GPT4])
        ...
        if uploaded_file is not None and file_valid:
            if st.button(texts['step_three_button'][language]):
                ...
                with analyze_result:
                    ...
                    if selected_model == OPENAI_GPT3 or selected_model == OPENAI_GPT4: 
                        analyze.gpt_stream_completion(prompt, model=selected_model)
                    else: 
